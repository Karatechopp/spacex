...
async function fetchCompanyInfo(url) {
    ...
    try {
        ...
        <a href="${json.links.website}" target="_blank"><img src="_images/spacex_x.png" class="link_icon">SpaceX official website</a>
        <p></p>
        <a href="${json.links.flickr}" target="_blank"><img src="_images/flickr.svg" class="link_icon">SpaceX Flickr</a>
        <p></p>
        <a href="${json.links.twitter}" target="_blank"><img src="_images/twitter.svg" class="link_icon">SpaceX</a>
        <p></p>
        <a href="${json.links.elon_twitter}" target="_blank"><img src="_images/twitter.svg" class="link_icon">Elon Musk</a>
        `
